            ...
            <div className="p-6 lg:p-8 flex flex-col justify-between">
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className="group bg-gradient-to-r from-teal-600 via-teal-500 to-cyan-500 text-white px-8 py-3.5 rounded-xl font-bold flex items-center gap-3 hover:shadow-xl hover:scale-105 transition-all duration-300 transform w-full justify-center lg:w-auto relative overflow-hidden"
                >
